import { Binary, Copy, RefreshCw, User } from "lucide-react";
...
export const Generator = () => {
  ...
  return (
    <section className="flex items-center flex-col h-screen w-full p-20 max-w-[700px]">
      <div className="flex items-center justify-center">
        <Binary size={32} className="text-brand" />
        <h2 className="text-[24px] text-white font-bold">GERADOR DE SENHAS</h2>
      </div>
      <div className="flex flex-col w-full gap-10">
        <Input placeholder="" iconTop={User} topName="" value={password} />
        <div className="flex flex-col w-full gap-5 items-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <button
              className="flex items-center justify-center gap-1 bg-brand text-white px-4 py-2.5 cursor-pointer"
              onClick={() => {
